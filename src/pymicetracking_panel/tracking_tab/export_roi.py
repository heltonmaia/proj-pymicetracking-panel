...
def export_roi_data(
    ...
    for roi in rois:
        ...
        if (
            str(type(roi))
            == "<class 'bokeh.models.annotations.geometry.BoxAnnotation'>"
        ):
        ...
        if (
            str(type(roi))
            == "<class 'bokeh.models.annotations.geometry.PolyAnnotation'>"
        ):
        ...
        if (
            ...
            try:
                ...
                if (
                    hasattr(roi, "actual_radius")
                    and hasattr(roi, "center_x")
                    and hasattr(roi, "center_y")
                ):
